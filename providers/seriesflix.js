...
var I = "6a44e47dc85b8f4224962d0f4be13276", P = "https://seriesflixhd.best", W = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36";
function m(n) {
...
function O(n) {
  ...
  return e.castellano = r(l == null ? void 0 : l[1]), e.latino = r(t == null ? void 0 : t[1]), e;
}
function q(n, e, t, l) {
  return d(this, null, function* () {
    if (!n || e !== "tv")
    ...
    try {
      ...
      let h = [];
      for (let [f, g] of [[u.castellano, "Castellano"],[u.latino, "Latino"]]) {
        if (f.length === 0)
          continue;
